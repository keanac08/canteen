...
class Pdf_P extends TCPDF {
    ...
    public function Header() {
		...
		$html = "Canteen POS System";
		$this->writeHTMLCell($w = 0, $h = 0, $x = 168, $y = 15, $html, $border = 0, $ln = 1, $fill = 0, $reseth = true, $align = 'top', $autopadding = true);
