...
<header class="main-header">
	...
	<!-- Navbar Right Menu -->
		<div class="navbar-custom-menu">
			<ul id="nav_pos" class="nav navbar-nav">
				...
				<li class="dropdown user user-menu">
					...
					<a href="#" class="dropdown-toggle" data-toggle="dropdown">
						...
						<img src="<?php echo base_url('resources/images/thumbs/girl_2.png'); ?>" class="user-image" alt="User Image">
						<!-- hidden-xs hides the username on small devices so only the image appears. -->
						<span class="hidden-xs"><?php echo $this->session->get_userdata()['ctn_fullname'];?></span>
					</a>
					<ul class="dropdown-menu">
						...
						<li class="user-header">
							...
							<p>
								<?php echo $this->session->get_userdata()['ctn_fullname'];?>
							</p>
						</li>
